        ...
        <div className="absolute md:right-8 right-2">
          {user ? (
            ...
            <Link href="/login">
              <Button
                variant="outline"
                className="relative bg-amber-50 cursor-pointer px-8 py-8 rounded-xl shadow-2xl border-pink-600 border-2 group overflow-hidden hover:text-amber-50 transition-all duration-150"
              >
